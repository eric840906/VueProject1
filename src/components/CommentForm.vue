<template>
    <div>
        ...
        <main role="main">
            ...
            <section class="jumbotron text-center" style="border-radius: 0; padding-bottom: 104px;; margin-bottom:0; backgroundImage:url(https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80); background-size: cover; background-position: center;">
                
                <div class="blink" style="padding: 96px 0;">
                    <h1 style="font-family: 'Tangerine', cursive; font-size: 4.5rem;">Leave Your Comment</h1><br>
                ...
                <div class="container">
                    <form @submit.prevent="commentPost">
                        <div class="d-flex">
                            ...
                            <input type="email" class="form-control" name="email" id="useremail" v-model="UserComments.email" placeholder="請輸入 Email" v-validate="'required|email'">
                            
                        </div>
            
                        <div class="form-group" style="margin-left:20px;">
                            <label for="username">暱稱</label>
                            <input type="text" class="form-control" name="name" id="username" v-model="UserComments.name" placeholder="輸入姓名">
