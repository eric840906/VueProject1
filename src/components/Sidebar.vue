    ...
    <div>
        ...
        <ul class="nav flex-column mb-2">
          <li class="nav-item">
            ...
            <router-link class="nav-link" to="/admin/orderlist"><i class="fas fa-clipboard-list"></i>訂單列表</router-link>
          </li>          
        </ul>
        <ul class="nav flex-column mb-2">
          <li class="nav-item">            
            <router-link class="nav-link" to="/admin/coupon"><i class="fas fa-ticket-alt"></i>優惠券</router-link>
          </li>          
        </ul>
